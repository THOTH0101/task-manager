				...
				{:else}
					<div class="mt-4 gap-4 py-3 sm:flex sm:flex-row-reverse">
						<Button
							color="blue"
							type="submit"
							class="bg-blue-600 px-8 text-sm font-semibold text-stone-50 hover:bg-blue-700 sm:w-auto"
						>
							Submit
						</Button>
						...
						<Button
							color="light"
							type="button"
							class="bg-stone-100 px-5 text-sm font-semibold text-stone-900 sm:w-auto"
							onclick={() => {
